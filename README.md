...
|Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software.|  **Fabricio Josue Apaza Morales**<br>TB1:Empathy Mapping, As-Is Scenario Mapping, Ubiquitous Language, 3 user stories, To-Be Scenario Mapping, Impact Mapping, Style Guidelines(General Style Guidelines, Web Style Guidelines), Information Architecture(Organization Systems, Labeling Systems, SEO Tags and Meta Tags, Searching Systems, Navigation Systems)                  |                   |
